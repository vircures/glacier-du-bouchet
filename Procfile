...
#     echo '{ "name": "glacier-du-bouchet", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/glacier-du-bouchet/glacier-du-bouchet
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/glacier-du-bouchet/glacier-du-bouchet production -p $PORT
